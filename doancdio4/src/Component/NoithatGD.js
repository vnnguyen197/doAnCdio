        ...
        return (
            ...
            <div>
                <article>
                    ...
                    <hr />
                    <div className="box">               
                        <a className="a" href="/Ntc1"><img src="Picture/salon.jpeg" width="225px" height="200px" /></a><br />
                        <div align="center">
                    ...
                    <div className="box">
                        <a className="a" href="/Ntc3"><img src="Picture/ketivi.jpg" width="225px" height="200px" /></a><br />
                        <div align="center">
                ...
                <footer className="mainfooter" style={{ bottom: -400, margin: 0, fontFamily: 'Arial, Helvetica, sans-serif', background: '#ffffff' }}>
                    <br />
                            ...
                            <div className="row">
                                <div className="col-md-6 col-lg-3">
                                    <div className="footer-about">
                                        ...
                                        <p>
                                            <a href="/Gioithieu"> Giới Thiệu Về NTC </a> <br />
