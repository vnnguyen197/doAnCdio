            ...
            <div>
                <article>
                    ...
                    <div className="box1" align="center">
                        <img width="500px" height="450px" src="Picture/mayxay.jpg" /><br />
                        <div align="center">
                ...
                <footer className="mainfooter" style={{ bottom: -600, margin: 0, fontFamily: 'Arial, Helvetica, sans-serif', background: '#ffffff' }}>
                    <br />
